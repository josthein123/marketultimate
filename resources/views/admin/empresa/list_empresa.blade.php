        ...
        <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card card-table">
                ...
                <div class="card-header">Lista de tus empresas


                    <div class="tools dropdown">
                      <a href="{{ url('empresa')}}"><span class="icon mdi mdi-playlist-plus">Nuevo</span></a>
                  ...
                  <table class="table table-striped table-hover table-fw-widget" id="table4">
                    ...
                    @if(count($empresas) > 0)
                        ...
                        <tr class="odd gradeX">
                            ...
                            @endif
                            <td class="actions">
                                <a href="{{ url('empresa/'.$emp->id_empresa.'/edit') }}"><button class="btn btn-space btn-warning btn-sm"><i style="color:white" class="icon icon-left mdi mdi-edit"></i></button></a>
                                <!--<button type="button" class="btn btn-space btn-danger btn-sm delete" id="swal-col-danger" data="{{$emp->id_empresa}}" ><i style="color:white"class="icon icon-left mdi mdi-delete" ></i></button>-->
                            </td>
