...
<div class="form-group row " >
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3 ">
        <div class="form-group">
        <label for="inputPassword">Año Fiscal</label>
        <select class="select2 select2-xs" id="agno_fiscal" name="agno_fiscal">

        @if(isset($row->agno_fiscal))
            <option value="2015" {{ $row->agno_fiscal == "2015" ? "selected":""}}>2015</option>
            <option value="2016" {{ $row->agno_fiscal == "2016" ? "selected":""}}>2016</option>
            <option value="2017" {{ $row->agno_fiscal == "2017" ? "selected":""}}>2017</option>
            <option value="2018" {{ $row->agno_fiscal == "2018" ? "selected":""}}>2018</option>
            <option value="2019" {{ $row->agno_fiscal == "2019" ? "selected":""}}>2019</option>
            <!--<option value="2020" {{ $row->agno_fiscal == "2020" ? "selected":""}}>2020</option>-->
        @else
        ...
        @if( $errors->has('agno_fiscal') )
            <ul class="parsley-errors-list filled" id="parsley-id-5"><li class="parsley-required">{{ $errors->first('agno_fiscal') }}</li></ul>
        @endif
        </div>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
...
<div class="form-group row">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-4">
        <div class="form-group">
            ...
            <input class="form-control form-control-xs" type="text" placeholder="Ingrese Web" id="web" name="web" autocomplete="off" value="{{ isset($row->web) ? $row->web : '' }}">
        </div>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
        <div class="form-group">
            <label for="inputPassword">Cod. de Sunat</label>
            <input class="form-control form-control-xs" type="text" placeholder="Ingrese Cod. de Sunat" id="cod_sunat" name="cod_sunat" autocomplete="off" value="{{ isset($row->cod_sunat) ? $row->cod_sunat : '' }}">
        </div>
    </div>
    <div class="col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2">
        <div class="form-group">
...
<div class="row pt-3">
    ...
    <div class="col-sm-12">
        <p class="text-right">
        <button class="btn btn-primary btn-ladda btn-ladda-spinner" type="submit">{{ $Modo == 'crear' ? 'Registrar empresa' : 'Modificar ' }}</button>
        <a href="{{url('list-empresa')}}"><button class="btn btn-space btn-secondary" type="button">Cancelar</button></a>
        </p>
    </div>
</div>
